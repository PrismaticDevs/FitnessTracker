            ...
            ZStack {
                ScrollView {
                    VStack(spacing: 16) { // Add some spacing between elements
                        WeightInput(Exercise: "Deadlift", WeightLeft: defaults.string(forKey: "DeadliftWeightLeft") ?? "", WeightRight: defaults.string(forKey:     "DeadliftWeightRight") ?? "", Weight: defaults.string(forKey: "DeafliftWeight") ?? "", Note: defaults.string(forKey: "DeadliftNote") ?? "")
                        ...
                        WeightInput(Exercise: "Hack Squat", WeightLeft: defaults.string(forKey: "Hack SquatWeightLeft") ?? "", WeightRight: defaults.string(forKey: "Hack SquatWightRight") ?? "", Weight: defaults.string(forKey: "Hack SquatWight") ?? "", Note: defaults.string(forKey: "Hack SquatNote") ?? "")
                        ...
                        WeightInput(Exercise: "Seated Calf Raise", WeightLeft: defaults.string(forKey: "Calf RaiseWeightLeft") ?? "", WeightRight: defaults.string(forKey: "Calf RaiseWeightRight") ?? "", Weight: defaults.string(forKey: "Calf RaiseWeight") ?? "", Note: defaults.string(forKey: "Calf RaiseNote") ?? "")
                        ...
                        WeightInput(Exercise: "Calf Press", WeightLeft: defaults.string(forKey: "Calf PressWeightLeft") ?? "", WeightRight: defaults.string(forKey: "Calf PressWeightRight") ?? "", Weight: defaults.string(forKey: "Calf RaiseWeight") ?? "", Note: defaults.string(forKey: "Calf PressNote") ?? "")
                        WeightInput(Exercise: "Leg Press", WeightLeft: defaults.string(forKey: "Leg PressWeightLeft") ?? "", WeightRight: defaults.string(forKey: "Leg PressWeightRight") ?? "", Weight: defaults.string(forKey: "Lef PressWeight") ?? "", Note: defaults.string(forKey: "Leg PressNote") ?? "")
                    }
