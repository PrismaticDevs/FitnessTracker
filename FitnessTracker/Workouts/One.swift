                ...
                ZStack {
                    ScrollView {
                        VStack {
                            ...
                            WeightInput(Exercise: "Single Arm Cable Lateral Raise", WeightLeft:       defaults.string(forKey: "Single Arm Cable Lateral RaiseWeight") ?? "", WeightRight: defaults.string(forKey: "Single Arm Cable Lateral RaiseWeightRight") ?? "", Weight: defaults.string(forKey: "Signle Arm Cable Lateral RaiseWeight") ?? "", Note: defaults.string(forKey: "Single Arm Cable Lateral RaiseNote") ?? "")
                        }
