                    ...
                    HStack {
                        VStack {
                            ...
                            TextField("Reps", text: $repsInput, prompt: Text("Reps").foregroundColor(.white.opacity(0.5)))
                                ...
                                .onChange(of: repsInput) { oldValue, newValue in
                                    ...
                                    defaults.set(reps, forKey: "left\(exercise)")
                                }
                                .onAppear {
                                    leftInput = "\(defaults.integer(forKey: "reps\(exercise)"))"
                                }
                        ...
                        VStack {
                            Text("Rest")
                                .padding(-4)
                                .font(.subheadline)
                            TextField("Rest", text: $repsInput, prompt: Text("Rest").foregroundColor(.white.opacity(0.5)))
                                .padding()
                                ...
                                .onChange(of: restInput) { oldValue, newValue in
                                    ...
                                    defaults.set(rest, forKey: "left\(exercise)")
                                }
                                .onAppear {
                                    restInput = "\(defaults.integer(forKey: "rest\(exercise)"))"
                                }
                        }
                    }
                    Section {
...
#Preview {
    WorkoutEntryView(exercise: "Exercise Test", weight: 100, left: 50, right: 50, sets: 3, reps: 12, rest: 90, note: "", onDelete: {})
}
