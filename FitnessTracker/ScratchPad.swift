...
//                                            .padding()
//                                            .background(combinedInput == "" && leftInput == "" && rightInput == "" ? Color.red.opacity(0.6).cornerRadius(10) : ColorPalette.accent.opacity(0.8).cornerRadius(10))
...
//                                .padding() .background(ColorPalette.accent.opacity(0.8).cornerRadius(10))
